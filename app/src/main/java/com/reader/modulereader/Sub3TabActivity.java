...
public class Sub3TabActivity extends Activity {
	 ...
	 { 
		 ...
		 {  
			 ...
			 if(er==READER_ERR.MT_OK_ERR)
					Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_ok+er.toString(),
							Toast.LENGTH_SHORT).show();
			 else
				 Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_failed+er.toString(),
							Toast.LENGTH_SHORT).show();
		 }
		 else
		 { 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myapp=(MyApplication) app;  
				...
				arradp_bank = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,MyApplication.spibank); 
				arradp_bank.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);  
				arradp_fbank = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,MyApplication.spifbank); 
				...
				spinner_lockbank = (Spinner) findViewById(R.id.spinner_lockbank); 
				 //����ѡ������ArrayAdapter��������         	 
				arradp_lockbank = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,MyApplication.spilockbank); 
				 //���������б�ķ��       
				...
				arradp_locktype = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,MyApplication.spilocktype); 
				...
				button_readop.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View arg0) {
						...
						try {
							...
							Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_excep+e.getMessage(),
									Toast.LENGTH_SHORT).show();
						}
				...
				button_lockop.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View arg0) {
						...
						try {
							...
							{
								Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_sub3lockfail,
										Toast.LENGTH_SHORT).show();
							}
						} catch (Exception e) {
							// TODO Auto-generated catch block
				...
				button_kill.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View arg0) {
						...
						try {
							 ...
							 if(er==READER_ERR.MT_OK_ERR)
							 {
								Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_killok,
										Toast.LENGTH_SHORT).show();
							 }
							else
							{
								Toast.makeText(Sub3TabActivity.this, MyApplication.Constr_killfailed,
										Toast.LENGTH_SHORT).show();
							}
