	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_save.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				{
					Toast.makeText(SubSystemActivity.this, MyApplication.Constr_subsysavefailed,
							Toast.LENGTH_SHORT).show();
					return;
				}
				Toast.makeText(SubSystemActivity.this, MyApplication.Constr_subsysexefin,
						Toast.LENGTH_SHORT).show();
			}
		});
		...
		button_default.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				myapp.spf.SaveReaderParams(myapp.Rparams);
				Toast.makeText(SubSystemActivity.this, MyApplication.Constr_subsysreavaid,
						Toast.LENGTH_SHORT).show();
			}
		});
